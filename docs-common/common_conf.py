# -*- coding: utf-8 -*-
#
# Common settings for the Sphinx documentation of the various GNATcoll Bindings
# components.
#
...
rst_epilog = """
.. |Tip| image:: ../../docs-common/tip.png
         :width: 15pt
         :alt: TIP:
.. |Note| image:: ../../docs-common/note.png
          :width: 15pt
          :alt: NOTE:
.. |Important| image:: ../../docs-common/important.png
               :width: 15pt
               :alt: IMPORTANT:
"""
...
# of the sidebar.
# html_logo = '../../docs-common/adacore_transparent.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '../../docs-common/favicon.ico'

# Add any paths that contain custom static files (such as style sheets) here,
# relative to this directory. They are copied after the builtin static files,
# so a file named "default.css" will overwrite the builtin "default.css".
html_static_path = ['../../docs-common']
